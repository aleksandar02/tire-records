...
$.extend($.validator, {
	...
	messages: {
		...
		number: "Dozvoljeni samo brojevi.",
		digits: "Dozvoljene samo cifre.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("Dozvoljeno {0} karaktera."),
        minlength: $.validator.format("Minimalno {0} karaktera."),
